...
if has('termguicolors') && &termguicolors
  " Set terminal colors to match the terminal background
  let g:terminal_ansi_colors = ['#000000', '#cd0000', '#00cd00', '#cdcd00', '#0000ee', '#cd00cd', '#00cdcd', '#e5e5e5', '#7f7f7f', '#ff0000', '#00ff00', '#ffff00', '#5c5cff', '#ff00ff', '#00ffff', '#ffffff']
endif

" Match the Normal background color with the terminal background
hi Normal guibg=#050C18 guifg=#ffffff
hi EndOfBuffer guifg=#5f87d7 guibg=NONE gui=NONE cterm=NONE
hi StatusLine guifg=#FFFFFF guibg=#050C18 gui=NONE cterm=NONE
hi StatusLineNC guifg=#CCCCCC guibg=#050C18 gui=NONE cterm=NONE
hi StatusLineTerm guifg=#000000 guibg=#050C18 gui=NONE cterm=NONE
hi StatusLineTermNC guifg=#666666 guibg=#050C18 gui=NONE cterm=NONE
hi VertSplit guifg=#666666 guibg=#050C18 gui=NONE cterm=NONE
...
hi TabLineSel guifg=#000000 guibg=#050C18 gui=NONE cterm=NONE
...
" Color: color13       #050C18           144               magenta
